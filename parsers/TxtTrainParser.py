...
#Java configuration
nltk.internals.config_java("/usr/libexec/java_home",options='-xmx4G')
...
stanford_bidirectional_tagger_path ="/Users/gunnar/Documents/ProvingGround/semeval2017-test/crfsemeval/stanford-postagger-full-2015-12-09/models/english-bidirectional-distsim.tagger"
stanford_postagger_jar_path ="/Users/gunnar/Documents/ProvingGround/semeval2017-test/crfsemeval/stanford-postagger-full-2015-12-09/stanford-postagger-3.6.0.jar"

#TO-DO: Folders will be changed to taos paths after debugging
train_folder= "/Users/gunnar/Documents/ProvingGround/semeval2017-test/scienceie2017_train/train2" #folder containing training data
output_folder= "/Users/gunnar/Documents/ProvingGround/parserOutput" #folder for pre-processed output - will contain files in the right format for CRF
dev_folder="/Users/gunnar/Documents/ProvingGround/semeval2017-test/scienceie2017/dev" # folder containing development data

#Define stopword list
stopwords = nltk.corpus.stopwords.words('english')

#Initialize Stanford POS Tagger
stan= StanfordPOSTagger(stanford_bidirectional_tagger_path,stanford_postagger_jar_path,encoding="utf8",java_options="-mx6g")
...
for f in flist_train:
    ...
    with io.open(os.path.join(output_folder,outputfile),'w', encoding="utf-8") as outf:
        ...
        for s in toktext:
            ...
            print("tokenwords Line225: {}".format(tokenwords))
            postag=stan.tag(tokenwords)

            print("Postag Line227: {}.".format(postag))
